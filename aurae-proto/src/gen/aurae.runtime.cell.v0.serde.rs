...
impl serde::Serialize for Cell {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.Cell", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Cell {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.Cell")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.Cell", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceAllocateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceAllocateRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for CellServiceAllocateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceAllocateRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceAllocateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceAllocateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceAllocateResponse", len)?;
        if !self.cell_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CellServiceAllocateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceAllocateResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceAllocateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceFreeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceFreeRequest", len)?;
        if !self.cell_name.is_empty() {
            struct_ser.serialize_field("cellName", &self.cell_name)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for CellServiceFreeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceFreeRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceFreeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceFreeResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceFreeResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CellServiceFreeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceFreeResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceFreeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStartRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceStartRequest", len)?;
        if !self.cell_name.is_empty() {
            struct_ser.serialize_field("cellName", &self.cell_name)?;
        }
...
impl<'de> serde::Deserialize<'de> for CellServiceStartRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceStartRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceStartRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStartResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceStartResponse", len)?;
        if self.pid != 0 {
...
impl<'de> serde::Deserialize<'de> for CellServiceStartResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceStartResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceStartResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStopRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceStopRequest", len)?;
        if !self.cell_name.is_empty() {
            struct_ser.serialize_field("cellName", &self.cell_name)?;
        }
        if !self.executable_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CellServiceStopRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceStopRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceStopRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStopResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.CellServiceStopResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CellServiceStopResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.CellServiceStopResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.CellServiceStopResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Executable {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.cell.v0.Executable", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.command.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Executable {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.cell.v0.Executable")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.cell.v0.Executable", FIELDS, GeneratedVisitor)
    }
}
