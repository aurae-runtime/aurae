...
export const protobufPackage = "aurae.runtime.cell.v0";
...
free(request: CellServiceFreeRequest): Promise<CellServiceFreeResponse> {
    // @ts-ignore
    return Deno.core.ops.ae__cell__cell_service__free(request);
}      
        
start(request: CellServiceStartRequest): Promise<CellServiceStartResponse> {
    // @ts-ignore
    return Deno.core.ops.ae__cell__cell_service__start(request);
}      
        
stop(request: CellServiceStopRequest): Promise<CellServiceStopResponse> {
    // @ts-ignore
    return Deno.core.ops.ae__cell__cell_service__stop(request);
}      
        }