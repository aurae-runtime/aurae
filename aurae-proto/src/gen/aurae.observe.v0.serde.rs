...
impl serde::Serialize for GetAuraeDaemonLogStreamRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.observe.v0.GetAuraeDaemonLogStreamRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetAuraeDaemonLogStreamRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.observe.v0.GetAuraeDaemonLogStreamRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.observe.v0.GetAuraeDaemonLogStreamRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSubProcessStreamRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.observe.v0.GetSubProcessStreamRequest", len)?;
        if self.channel_type != 0 {
...
impl<'de> serde::Deserialize<'de> for GetSubProcessStreamRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.observe.v0.GetSubProcessStreamRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.observe.v0.GetSubProcessStreamRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for LogItem {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.observe.v0.LogItem", len)?;
        if !self.channel.is_empty() {
...
impl<'de> serde::Deserialize<'de> for LogItem {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.observe.v0.LogItem")
            }
        ...
        deserializer.deserialize_struct("aurae.observe.v0.LogItem", FIELDS, GeneratedVisitor)
    }
}
