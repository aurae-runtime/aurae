...
impl serde::Serialize for Cell {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.Cell", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Cell {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.Cell")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.Cell", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceAllocateRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceAllocateRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for CellServiceAllocateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceAllocateRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceAllocateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceAllocateResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceAllocateResponse", len)?;
        if !self.cell_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CellServiceAllocateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceAllocateResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceAllocateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceFreeRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceFreeRequest", len)?;
        if !self.cell_name.is_empty() {
            struct_ser.serialize_field("cellName", &self.cell_name)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for CellServiceFreeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceFreeRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceFreeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceFreeResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceFreeResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CellServiceFreeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceFreeResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceFreeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStartRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceStartRequest", len)?;
        if !self.cell_name.is_empty() {
            struct_ser.serialize_field("cellName", &self.cell_name)?;
        }
...
impl<'de> serde::Deserialize<'de> for CellServiceStartRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceStartRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceStartRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStartResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceStartResponse", len)?;
        if self.pid != 0 {
...
impl<'de> serde::Deserialize<'de> for CellServiceStartResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceStartResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceStartResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStopRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceStopRequest", len)?;
        if !self.cell_name.is_empty() {
            struct_ser.serialize_field("cellName", &self.cell_name)?;
        }
        if !self.executable_name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CellServiceStopRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceStopRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceStopRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CellServiceStopResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.CellServiceStopResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for CellServiceStopResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.CellServiceStopResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.CellServiceStopResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Container {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.Container", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Container {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.Container")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.Container", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Executable {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aurae.runtime.v0.Executable", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.command.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Executable {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.Executable")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.Executable", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Pod {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.Pod", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Pod {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.Pod")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.Pod", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceAllocateRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceAllocateRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceAllocateRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceAllocateRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceAllocateRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceAllocateResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceAllocateResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceAllocateResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceAllocateResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceAllocateResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceFreeRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceFreeRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceFreeRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceFreeRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceFreeRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceFreeResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceFreeResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceFreeResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceFreeResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceFreeResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceStartRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceStartRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceStartRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceStartRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceStartRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceStartResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceStartResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceStartResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceStartResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceStartResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceStopRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceStopRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceStopRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceStopRequest")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceStopRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PodServiceStopResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aurae.runtime.v0.PodServiceStopResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PodServiceStopResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aurae.runtime.v0.PodServiceStopResponse")
            }
        ...
        deserializer.deserialize_struct("aurae.runtime.v0.PodServiceStopResponse", FIELDS, GeneratedVisitor)
    }
}
